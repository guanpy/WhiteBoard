...
public final class WhiteBoardVariable {
    ...
    public interface  PenSize{
        /**大*/
        int LARRGE = OperationUtils.dip2px(9) ;
        /**中*/
        int MIDDLE = OperationUtils.dip2px(6) ;
        /**小*/
        int MINI = OperationUtils.dip2px(4) ;
    }
    /**橡皮擦大小*/
    public interface  EraserSize{
        /**大*/
        int LARRGE = OperationUtils.dip2px(16) ;
        /**中*/
        int MIDDLE = OperationUtils.dip2px(9) ;
        /**小*/
        int MINI = OperationUtils.dip2px(4) ;
    }
    /**圆环宽度大小*/
    public interface  RingSize{
        /**大*/
        int LARRGE = OperationUtils.dip2px(3) ;
        /**小*/
        int MINI = OperationUtils.dip2px(1) ;
    }
    /**文字风格*/
